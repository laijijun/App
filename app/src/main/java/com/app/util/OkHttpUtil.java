...
public class OkHttpUtil {
    ...
    public void getDataAsyn(String url, final NetCall netCall) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                netCall.success(response.body().string());
    ...
    public void postJsonAsyn(String url, Map<String,String> head, Map<String,String> body, final NetCall netCall) {
        ...
        builder.post(RequestBody.create(mediaType, JsonUtil.toJson(body)));
